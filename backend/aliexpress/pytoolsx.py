...
def set_volume(level):
    try:
      ...
      print(f"System Volume set to {level}")
        ...
        print("Doesn't work on mac devices, only windows")
...
def hotkey(*keys):
    """Hold down keys in sequence and release them in reverse order."""
    for key in keys:
